...
The code in this repository is Unlicensed (public domain; see `LICENSE`). The
map data embedded in the deck remains subject to the terms of its respective
sources. If you redistribute the deck or the map assets, you must retain the
attributions below.
...
| Non-UK land (France, Ireland, Isle of Man) | Natural Earth | Public domain | Natural Earth. Free vector and raster map data @ naturalearthdata.com |
| Seas, channels, estuaries, straits | MarineRegions / SeaVoX v19 (BODC/VLIZ) | CC BY 4.0 | British Oceanographic Data Centre (BODC), United Kingdom; (2023): Polygon dataset of the extent of water bodies from the SeaVoX Salt and Fresh Water Body Gazetteer (v19). Available online at https://www.marineregions.org/. DOI: 10.14284/590 |
...
### ONS International Territorial Level (ITL1)
...
> Contains LPS Intellectual Property © Crown copyright and database right 2026. This information is licensed under the terms of the Open Government Licence (http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3).

### martinjc/UK-GeoJSON (Scottish council areas)

> Contains Ordnance Survey, Office of National Statistics, National Records Scotland and LPS Intellectual Property data © Crown copyright and database right 2016. Data licensed under the terms of the Open Government Licence (http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3).

### Natural Earth (non-UK land)

Natural Earth data is in the public domain; attribution is not required but is appreciated:

> Natural Earth. Free vector and raster map data @ naturalearthdata.com.

### MarineRegions / SeaVoX (bodies of water)

> British Oceanographic Data Centre (BODC), United Kingdom; (2023): Polygon dataset of the extent of water bodies from the SeaVoX Salt and Fresh Water Body Gazetteer (v19). Available online at https://www.marineregions.org/. DOI: 10.14284/590
