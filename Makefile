...
build/media/_maps.js: build/maps/layers/extra_land.min.svg build/maps/layers/counties.min.svg build/maps/layers/cities.min.svg build/maps/layers/regions.min.svg build/maps/layers/water.min.svg build/maps/layers/motorways.min.svg utils/uk_geog/build_maps_js.py
...
build/uk_geog.csv: utils/uk_geog/aggregate_csvs.py build/regions.csv build/counties.csv build/cities.csv build/bodies_of_water.csv build/motorways.csv src/data/cities.csv src/data/uk_geog.csv
	python $< \
		build/regions.csv \
		build/counties.csv \
		build/cities.csv \
